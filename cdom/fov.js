 ...
 * @returns {void}
 */
export function computeField({update, ...params}) {
  for (const {depth, ...pos} of iterateField(params))
    update(pos, depth);
}
 ...
 *
 * The depth is the column within the first quadrant to encounter each location.
 *
