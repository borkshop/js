...
export function makeShard({
    ...
    function createEntity(id) {
        return extendedEntity(id, /** @type {CreateEntity} */({
            ...
            get taskInit() { return memoryGet(id, "taskInit") },
            set taskInit(task) { memorySet(id, "taskInit", task) },

            get task() { return memoryGet(id, "task") },
            set task(task) { memorySet(id, "task", task) },
        }));
    }
