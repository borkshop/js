...
export const faceArea = faceSize * faceSize;
export const worldSize = tileSize * faceSize;
...
export const faceCorners = faceTransforms.map(matrix => multiply(matrix, cornerTransform));
export const faceOrigins = faceTransforms.map(matrix => multiply(matrix, originTransform));
 ...
 */
export function tileCoordinate(t) {
 ...
 * @returns {number}
 */
export function neighbor(t, direction) {
 ...
 * @returns {Matrix}
 */
export function tileTransform(t) {
